...
@WebFilter(filterName = "CompressionFilter",
        initParams = {
                @WebInitParam(name = "compressionThreshold", value = "128"),
                @WebInitParam(name = "compressionBuffer", value = "8192"),
                @WebInitParam(name = "compressionMimeTypes", value = "text/html,text/plain,text/xml"),
                @WebInitParam(name = "debug", value = "0")
        },
        urlPatterns = "/CompressionTest")
